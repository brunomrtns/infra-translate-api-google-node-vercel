/* eslint-disable */ // ## Usando técnica secreta de engenharia reversa para gerar token de tradução vadido para Google Translate
/**
...
const fetchToken = (text)=>generateToken(text);
const window = {
...
function generateToken(srt) {
    ...
    for(var e = [], f = 0, g = 0; g < srt.length; g++){
        ...
        l < 128 ? e[f++] = l : (l < 2048 ? e[f++] = l >> 6 | 192 : ((l & 64512) === 55296 && g + 1 < srt.length && (srt.charCodeAt(g + 1) & 64512) === 56320 ? (l = 65536 + ((l & 1023) << 10) + (srt.charCodeAt(++g) & 1023), e[f++] = l >> 18 | 240, e[f++] = l >> 12 & 63 | 128) : e[f++] = l >> 12 | 224, e[f++] = l >> 6 & 63 | 128), e[f++] = l & 63 | 128);
    }
    srt = b;
